...
export type Client = {
  name: string;
  logo: string;
  segment: "AlimentÃ­cio" | "Automotivo" | "Sistemista" | "Industrial" | "Hospitalar" | "FarmacÃªutico";
};

export const CLIENTS: Client[] = [
  { name: "Rio Acima", logo: assetUrl("images/clientes/logo_rioacima.png"), segment: "AlimentÃ­cio" },
  { name: "Kentisa", logo: assetUrl("images/clientes/logo_kentisa.png"), segment: "AlimentÃ­cio" },
  { name: "Morita", logo: assetUrl("images/clientes/morita-300x288.png"), segment: "AlimentÃ­cio" },
  { name: "Elo Fruti", logo: assetUrl("images/clientes/logo_elo.png"), segment: "AlimentÃ­cio" },
  { name: "Agro Bonfim", logo: assetUrl("images/clientes/logo_agrobonfim.png"), segment: "AlimentÃ­cio" },
  { name: "Els Bananas", logo: assetUrl("images/clientes/elsbananas-300x234.jpg"), segment: "AlimentÃ­cio" },
  { name: "MJ Maciel", logo: assetUrl("images/clientes/maciel.jpg"), segment: "AlimentÃ­cio" },
  { name: "Campo Alto", logo: assetUrl("images/clientes/campoalto-300x136.png"), segment: "AlimentÃ­cio" },
  { name: "Hortigil Hortifruti", logo: assetUrl("images/clientes/hortigil-hortifruti-vitalizaplast.jpg"), segment: "AlimentÃ­cio" },
  { name: "Natural da Terra", logo: assetUrl("images/clientes/natural-da-terra-vitalizaplast.jpg"), segment: "AlimentÃ­cio" },
  { name: "Naturalis", logo: assetUrl("images/clientes/naturalis-vitalizaplast.jpg"), segment: "AlimentÃ­cio" },
  { name: "Domino's Pizza", logo: assetUrl("images/clientes/dominos-1.png"), segment: "AlimentÃ­cio" },
  { name: "Oba Hortifruti", logo: assetUrl("images/clientes/Oba-300x300.png"), segment: "AlimentÃ­cio" },
  { name: "Oggi Sorvetes", logo: assetUrl("images/clientes/df82d0ea71135843c3a33bd5e1d7c881-300x184.png"), segment: "AlimentÃ­cio" },
  ...
  { name: "ParanoÃ¡", logo: assetUrl("images/clientes/LOGO-PARANOA.png"), segment: "Industrial" },
  ...
  { name: "Johnson & Johnson", logo: assetUrl("images/clientes/logotipo-Johnson-Johnson-historia-300x167.jpg"), segment: "FarmacÃªutico" },
  { name: "Hosplog", logo: assetUrl("images/clientes/hosplog-240x300.png"), segment: "Hospitalar" },
  { name: "Hospital das ClÃ­nicas", logo: assetUrl("images/clientes/hospital-das-clinicas-vitalizaplast.jpg"), segment: "Hospitalar" },
  { name: "Colgate-Palmolive", logo: assetUrl("images/clientes/Colgate-Palmolive.png"), segment: "FarmacÃªutico" },
];
