...
const STORY_BLOCKS = [
  ...
  "Ate o inicio de 2013, produtores, distribuidores de alimentos e hortifruti, supermercados, montadoras e sistemistas da cidade de Sao Paulo nao tinham nenhuma opcao para a solucao de um problema que atingia a todos do segmento: a higienizacao e a revitalizacao de suas caixas plasticas.",
  "Percebendo a carencia deste servico no mercado, Roberto Rodrigues Junior, que atua como empresario no segmento plastico ha mais de 30 anos, iniciou em janeiro de 2013 as atividades da VITALIZA CLEAN.",
];

const DIFFERENTIALS = [
  "Capacidade para higienizar centenas de caixas por hora.",
  "Equipamentos de alta potencia para um processo completo.",
  "Mao de obra especializada para lavagem, higienizacao e revitalizacao.",
  "Agilidade operacional para devolver as caixas limpas em curto espaco de tempo.",
];

export default function NossaHistoriaInstitutionalV2() {
  useEffect(() => {
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="max-w-4xl">
              <span className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-semibold text-cyan-200 backdrop-blur-sm">
                Conheca a nossa empresa
              </span>
              <h1 className="mt-6 text-4xl font-extrabold leading-tight text-white md:text-5xl lg:text-6xl">
                A historia da <span className="text-cyan-300">VITALIZA CLEAN</span> nasceu para resolver uma necessidade real do mercado
              </h1>
              <p className="mt-6 max-w-3xl text-justify text-lg leading-relaxed text-slate-100 md:text-xl">
                Desde janeiro de 2013, atuamos com foco em lavagem, higienizacao e revitalizacao de caixas plasticas e outros produtos plasticos para segmentos que exigem produtividade, cuidado e confianca operacional.
              </p>

              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                <div className="rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-sm">
                  <div className="text-3xl font-black text-white">2013</div>
                  <div className="mt-1 text-sm text-cyan-100">Inicio das atividades da empresa</div>
                </div>
                <div className="rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-sm">
                  <div className="text-3xl font-black text-white">30+ anos</div>
                  <div className="mt-1 text-sm text-cyan-100">de experiencia de mercado no segmento plastico</div>
                </div>
                <div className="rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-sm">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-start">
            <div>
              ...
              <h2 className="mt-5 text-3xl font-bold text-slate-900 md:text-4xl">
                Especializacao que trouxe uma nova solucao para Sao Paulo
              </h2>
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-3xl bg-slate-950 p-6 text-white shadow-xl shadow-slate-200/50">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-slate-200">
                    A empresa surgiu para suprir a carencia de um servico altamente especifico e essencial para cadeias logisticas exigentes.
                  </p>
                </div>
                <div className="rounded-3xl border border-emerald-100 bg-emerald-50 p-6 shadow-xl shadow-emerald-100/60">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-slate-700">
                    Alimenticio, automotivo, farmaceutico e outros setores que dependem de higienizacao com regularidade e padrao.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
            <blockquote className="rounded-[2rem] border border-cyan-100 bg-gradient-to-r from-cyan-50 via-white to-blue-50 px-8 py-10 shadow-lg shadow-cyan-100/60 md:px-12">
              <p className="text-justify text-xl font-semibold leading-relaxed text-slate-900 md:text-2xl">
                "Criamos a VITALIZA CLEAN para poder suprir de forma adequada essa necessidade. Finalmente o mercado pode contar com uma empresa especializada na lavagem e higienizacao de caixas plasticas."
              </p>
        ...
        <section className="bg-slate-50 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[1fr_0.95fr] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-6 text-justify text-lg leading-relaxed text-slate-600">
                  A VITALIZA CLEAN tem capacidade para higienizar centenas de caixas por hora, o que agiliza o processo e permite que os clientes tenham suas caixas limpas e revitalizadas em curto espaco de tempo. Esse procedimento exige produtos adequados, mao de obra especializada e equipamentos de alta potencia para que o processo seja completo.
                </p>
                <p className="mt-4 text-justify text-lg leading-relaxed text-slate-600">
                  Se a sua empresa necessita de servicos de higienizacao e revitalizacao em produtos plasticos, a conclusao e simples: a VITALIZA CLEAN e a melhor solucao para atender essa necessidade.
                </p>
              </div>
            ...
            <div className="mt-12 space-y-6">
              <div className="rounded-[2rem] bg-white p-6 shadow-2xl shadow-slate-200/70">
                <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch">
                  ...
                  <div className="rounded-[1.5rem] bg-white p-8 shadow-xl shadow-slate-200/50">
              ...
              <div className="rounded-[2rem] bg-gradient-to-br from-emerald-500 via-cyan-500 to-blue-600 p-8 text-white shadow-2xl shadow-cyan-200/70">
                ...
                <p className="mt-4 text-justify text-xl font-semibold leading-relaxed">
                  Desenvolver e realizar servicos inovadores e inteligentes para atender e superar as expectativas de nossos clientes, contribuindo para nossas metas economicas, sociais e ambientais.
                </p>
